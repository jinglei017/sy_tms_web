        ...
        saveNewDriverInf(){
            ...
            var newDriverInfo = {
                carrierPartyInfo:{
                    ...
                    imgContactInfo:{
                        contact:this.currentOrderInfo.imgContactInfo.contact
                    },
            ...
            postRequest(tmsUrl + "/query/tfoOrderInfo.json?token="+that.logininf.token+"&timeStamp="+that.logininf.timeStamp,searchFormArr,function(data){
                ...
                if(data.result.carrierPartyInfo != null){
                    if(data.result.carrierPartyInfo.imgContactInfo != null){
                    	if(data.result.carrierPartyInfo.imgContactInfo.contact != null){
                    		that.OrderCarrierContact = data.result.carrierPartyInfo.imgContactInfo.contact;
                    	}else{
                    ...
                    if(data.result.carrierPartyInfo.drvContactInfo != null){
                    	if(data.result.carrierPartyInfo.drvContactInfo.contact != null){
                    		that.OrderCarrierDriver = data.result.carrierPartyInfo.drvContactInfo.contact;
                    	}else{
                    		that.OrderCarrierDriver = {};
                    	}
                    	if(data.result.carrierPartyInfo.drvContactInfo.eqp != null){
        ...
        getOrderDetails(template,order,isAbnormalPage){
			...
			getRequest(omsUrl + "/query/OrderInfoDetail.json?token="+that.logininf.token+"&timeStamp="+that.logininf.timeStamp+"&orderId="+order.omOrderId,function(data){
                ...
                if(data.result.shipperPartyInfo != null){
                    ...
                    if(data.result.shipperPartyInfo.imgContactInfo != null){
                        if(data.result.shipperPartyInfo.imgContactInfo.contact != null){
                            that.shipperPartyContact = data.result.shipperPartyInfo.imgContactInfo.contact;
                        }else{
                    ...
                    if(data.result.shipperPartyInfo.locationInfo != null){
                        if(data.result.shipperPartyInfo.locationInfo.location != null){
                            that.shipperPartyLocation = data.result.shipperPartyInfo.locationInfo.location;
                        }else{
                            that.shipperPartyLocation = {};
                        }
                        if(data.result.shipperPartyInfo.locationInfo.contactInfo.contact != null){
                            that.shipperPartyLocationContact = data.result.shipperPartyInfo.locationInfo.contactInfo.contact;
                        }else{
                ...
                if(data.result.receiptPartyInfo != null){
                    ...
                    if(data.result.receiptPartyInfo.imgContactInfo != null){
                        if(data.result.receiptPartyInfo.imgContactInfo.contact != null){
                            that.receiptPartyContact = data.result.receiptPartyInfo.imgContactInfo.contact;
                        }else{
                    ...
                    if(data.result.receiptPartyInfo.locationInfo != null){
                        if(data.result.receiptPartyInfo.locationInfo.location != null){
                            that.receiptPartyLocation = data.result.receiptPartyInfo.locationInfo.location;
                        }else{
                            that.receiptPartyLocation = {};
                        }
                        if(data.result.receiptPartyInfo.locationInfo.contactInfo.contact != null){
                            that.receiptPartyLocationContact = data.result.receiptPartyInfo.locationInfo.contactInfo.contact;
                        }else{
