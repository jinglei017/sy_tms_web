    ...
    methods: {
        ...
        addOrderCarrierFun() { // 添加合作商 —— 按钮
            ...
            for (var i = 0; i < that.orderList.length; i++) {
                ...
                //获取订单详情
                getRequest(tmsUrl + "/busShared/queryOrderInfoDetail.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + that.orderList[i].omOrderId, function (data) {
                    var parms1 = {};
        ...
        publicGetOrderListFun() {
            ...
            that.checkedNum = 0;
            //获取订单列表
            postRequest(tmsUrl + "/busShared/selectStoOrderInfoPage.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, searchFormArr, function (res) {
        ...
        orderCancel() { // 批量订单取消
            ...
            postRequest(tmsUrl + "/busShared/saveBatchCancelOrderInfo.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, params, function (data) {
        ...
        orderAuditStatus0() { // 批量 订单审核 不通过
            ...
            postRequest(tmsUrl + "/busShared/saveBatchAuditOrderInfo.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, params, function (data) {
        ...
        orderAuditStatus1() { // 列表一个、、批量多选 、、、订单页 提交并审核通过   订单审核 通过
            ...
            switch (that.auditOrderType) {
                case '0': // 列表一个
                    ...
                    postRequest(tmsUrl + "/busShared/saveAuditOrderInfo?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, param, function (data) {
        ...
        orderToActivate() { // 订单激活
            ...
            postRequest(tmsUrl + "/busShared/saveBatchSubmitOrderInfo.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, params, function (res) {
        ...
        getOrderDetails(template, order) {
            ...
            getRequest(tmsUrl + "/busShared/queryOrderInfoDetail.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + order.omOrderId, function (data) {
                ...
                if (data.result.order != null) {
                    ...
                    $(".overdueTime").html(that.orderDetail.completeTime);
                } else {
                    that.orderDetail = {};
                ...
                if (that.orderDetail.orderType != undefined) {
                    ...
                    } else if (that.orderDetail.orderType == "SFO") {
                        that.isShippingOrder = true;
                    } else {
        ...
        activeStatusFun1(item) {
            ...
            if (item.orderInd == "normal") {
                ...
                if (item.completeStatus =='INIT') {
                    ...
                    if (r == true) {
                        ...
                        postRequest(tmsUrl + "/busShared/saveCancelStoOrderInfo.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, params, function (data) {
            ...
            if (item.orderInd == "house") {
                ...
                if (item.auditStatus =='0') {
                    let r = confirm("确定取消所抢共享订单？");
                    if (r == true) {
                        let arr = item.customerRefNo.split("-");
                        var params = {
                            refId: item.omOrderId,
                            refNo: arr[0],
                            refType:3
                    ...
                    //已审核无法取消
                    imitatePopup("共享订单配送中无法取消！",'alert');
                }
            }
        },
        //订单内页 取消激活
        ...
        getReceiptImgList(omOrderId) { // 获取图片列表
            var that = this;
            that.receiptImgList = [];
            getRequest(tmsUrl + "/busShared/selectOrderReceiptImgBase64.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + omOrderId, function (res) {
        ...
        getReceiptFilesList(omOrderId) { // 获取订单附件列表
            ...
            that.srcFileList = [];
            getRequest(tmsUrl + "/busShared/selectOrderAnnexObjFiles.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + omOrderId, function (res) {
                var newArray = [];
                for (var i = 0; i < res.result.length; i++) {
        ...
        clickUploadOrderFiles01() { // 上传附件 类型：0 - 上传订单附件（订单新增），1 - 上传订单附件（订单修改）
            ...
            that.receiptImgList = [];
            getRequest(tmsUrl + "/busShared/selectOrderReceiptImgBase64.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + that.orderDetail.omOrderId, function (res) {
                for (var i = 0; i < res.result.length; i++) {
                    var param = {
                        src: ImgWebsite + res.result[i].extValue,
                        omExtId: res.result[i].omExtId
                ...
                that.receiptFilesList = [];
                getRequest(tmsUrl + "/busShared/selectOrderAnnexObjFiles.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + that.orderDetail.omOrderId, function (res) {
                    var newArray = [];
                    for (var i = 0; i < res.result.length; i++) {
                        var string0 = res.result[i].extValue.split('/'), extValue = '';
                        for (var s = 0; s < string0.length; s++) {
        ...
        getLogisticsInfo(orderInfo) { // 物流信息
            ...
            postRequest(tmsUrl + "/busShared/queryActInfoDetail.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, orderinf, function (data) {
                ...
                getRequest(tmsUrl + "/busShared/queryOrderInfoDetail.json?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp + "&orderId=" + orderInfo.omOrderId, function (res) {
        ...
        saveNewOrderInfo() { // 订单  新增、修改
            ...
            that.orderDetail.orderType = 'STO';
            ...
            switch (that.clickBtnType) {
                case 'add':
                    if (that.orderDetail.omOrderId != undefined && that.orderDetail.omOrderId != '') {  // 修改
                        postRequest(tmsUrl + "/busShared/updateStoOrderHeadInfo?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, omOrderHeadInfoModel, function (data) {
                            that.orderDetailInfoFun(data);
                            that.tableOrderItemAuditStatus = data.result.orderStatus.auditStatus;
                            that.getSearchVal();
                        });
                    } else {  // 新增
                        postRequest(tmsUrl + "/busShared/insertStoOrderHeadInfo?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, omOrderHeadInfoModel, function (data) {
                            that.orderDetailInfoFun(data);
                            that.tableOrderItemAuditStatus = data.result.orderStatus.auditStatus;
                            that.getSearchVal();
                        });
        ...
        saveOrderHead() { // 订单  新增、修改
            ...
            postRequest(tmsUrl + "/busShared/updateStoOrderInfo?token=" + that.logininf.token + "&timeStamp=" + that.logininf.timeStamp, omOrderHeadInfoModel, function (data) {
                that.orderDetailInfoFun(data);
                that.getSearchVal();
            });
        },
        ...
        savePackageGoodsListInfo(index) {  //保存单个包裹商品
            ...
            that.orderItemDetail = that.packageGoodsList[index];
            /*if(that.orderItemDetail.orderItem.partyName == ""){
                alert("请填写货主名称");
                return false;
            }
            if(that.orderItemDetail.orderItem.partyCode == ""){
                alert("请填写货主名称");
                return false;
            }*/
            if (that.orderDetail.orderNature == "" || that.orderDetail.orderNature == undefined) {
            ...
            if (that.orderItemDetail.orderItem.unitPrice == "" && that.orderItemDetail.orderItem.unitPrice != 0) {
                alert("请填写单价");
                return false;
            }
            ...
            if (that.orderItemDetail.orderItem.amount == "" && that.orderItemDetail.orderItem.amount != 0) {
                alert("请填写总价值");
                return false;
            }
